...
const MainSection = ({ setEmployeeId, showLeftNav }) => {  // Add showLeftNav to props
  ...
  return (
    <>
      ...
      <main className={`mainContainer ${showLeftNav ? 'shifted' : ''}`}>  {/* Add shifted class conditionally */}
        <div className="mainWrapper">
          ...
          <div className="employeeHeader">
            ...
            >
              <IoMdAdd size="20" color="#fffff" />Add Employee
            </button>
          </div>
